...
#define STRING_CONFIG_H_AUTHOR "Howard Su" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "flsun 3D"
...
#define MANUAL_Z_HOME_POS 291.6 // Distance between the nozzle to printbed after homing
